...
const Footer = ({ onNavigate }) => {
  ...
  // Social media icons - simple SVGs for performance
  const SocialIcon = ({ href, children }) => (
    <a href={href} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors duration-300">
      {children}
    </a>
  );
