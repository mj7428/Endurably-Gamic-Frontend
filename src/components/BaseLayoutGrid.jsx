...
const BaseLayoutCard = ({ layout }) => {
  ...
  return (
    <div className="bg-gray-800 border border-gray-700 rounded-xl overflow-hidden shadow-lg transition-all duration-300 ease-in-out hover:shadow-md hover:shadow-red-500/50 hover:-translate-y-1 group flex flex-col h-88">
      ...
      <div className="relative">
        ...
        />
        <div className="absolute top-0 right-0 bg-red-600 text-white text-xs font-bold px-3 py-1.5 rounded-bl-lg">
      ...
      <div className="p-3 flex flex-col flex-grow justify-between"> 
        <div>
          <h3 className="text-md font-bold text-gray-100 mb-1 group-hover:text-red-400 transition-colors h-12 line-clamp-2">
            {layout.title}
          </h3>
        </div>
        ...
        <div className="mt-2 flex items-end justify-between">
            ...
            <a 
              ...
              className="flex items-center justify-center px-3 py-1.5 bg-red-600 text-white font-semibold rounded-lg transition-colors duration-300 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50 text-xs"
            >
              <LinkIcon />
              Open Link
            </a>
